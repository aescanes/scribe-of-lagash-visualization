...
export async function ensureOutlineFile(app: App, path: string): Promise<void> {
	...
	const body = [
		...
		"     rewritten. Edit the table by hand; click a placeholder card in the",
		"     line view to create a row's note.",
		"",
		"     Each row plans one chapter or scene. Fill the columns that match how",
		"     this book is organised on disk — pick ONE layout per book:",
		"",
		"       Chapters as files, no acts . . . . . Chapter                -> Chapter 1.md",
		"       Chapters as files, in act folders . . Act + Chapter          -> Act I/Chapter 1.md",
		"       Scenes in chapter folders . . . . . . Chapter + Scene        -> Chapter 1/Scene 2.md",
		"       Scenes in chapter folders, with acts  Act + Chapter + Scene  -> Act I/Chapter 1/Scene 2.md",
		"       Scenes with no chapter . . . . . . .  Scene (+ optional Act) -> Scene 2.md",
		"       Custom folder (overrides Act) . . . . Folder                 -> <Folder>/Chapter 1.md",
		"",
		...
		"     Line    = a line name or id from the Lines file.",
		"     Summary = shown on the card, and becomes the note body when created.",
